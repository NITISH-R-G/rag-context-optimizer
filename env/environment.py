...
class RagContextOptimizerEnv:
    ...
    async def reset(self) -> StepResult:
        ...
        self._available_chunks = self._rank_chunks_for_query(
    ...
    async def state(self) -> dict:
        ...
        return {
            ...
            "available_artifact_ids": [
                chunk.chunk_id for chunk in self._available_chunks
            ],
    ...
    def _chunk_map(self) -> dict[str, Chunk]:
        if self._chunk_map_cache is None or len(self._chunk_map_cache) != len(
            ...
            self._chunk_map_cache = {
                chunk.chunk_id: chunk for chunk in self._available_chunks
            }
    ...
    def _total_tokens_used(self) -> int:
        return sum(
            self._effective_chunk_tokens(chunk_id) for chunk_id in self._selected_chunks
        )
