...
def test_fit_citations_into_prompt():
    ...
    citations = ["doc1", "doc2"]
    result, ready, _notes = _fit_citations_into_prompt(prompt, citations, 10, 5, prompt, "balanced")
...
def test_fit_citations_into_prompt_grounded():
    prompt = "This is a prompt."
    citations = ["doc1", "doc2"]
    result, _ready, notes = _fit_citations_into_prompt(prompt, citations, 10, 5, prompt, "grounded")
