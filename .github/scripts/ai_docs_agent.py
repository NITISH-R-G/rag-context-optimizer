...
def get_repo_context() -> dict[str, Any]:
    ...
    try:
        with open("docs/architecture.md", "r") as f:
         ...
         print(f"Could not load architecture diagrams: {e}")
...
def main():
    ...
    if not api_key:
         print("No OPENAI_API_KEY found. AI Documentation generation skipped.")
        ...
        print("Calling OpenAI API to generate docs...")
