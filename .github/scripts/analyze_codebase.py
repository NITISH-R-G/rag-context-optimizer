...
def analyze_codebase(root_dir="."):
    ...
    for subdir, _, files in os.walk(root_dir):
        if ('.git' in subdir or '.github' in subdir or 'venv' in subdir or 'env' in subdir and 'env' != subdir[2:]) and 'env' not in subdir: # Allow scanning the actual env package if any
                 continue
